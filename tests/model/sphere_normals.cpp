...
bool normal_on_a_sphere_at_a_point_on_the_x_axis() {
    mn::Sphere sphere;
    mn::Vector n = sphere.normal_at(mn::make_point(1.0, 0.0, 0.0));
...
bool normal_on_a_sphere_at_a_point_on_the_y_axis() {
    mn::Sphere sphere;
    mn::Vector n = sphere.normal_at(mn::make_point(0.0, 1.0, 0.0));
...
bool normal_on_a_sphere_at_a_point_on_the_z_axis() {
    mn::Sphere sphere;
    mn::Vector n = sphere.normal_at(mn::make_point(0.0, 0.0, 1.0));
...
bool normal_on_a_sphere_at_a_non_axial_point() {
    ...
    mn::Vector n = sphere.normal_at(mn::make_point(sqrt_of_3 / 3, sqrt_of_3 / 3, sqrt_of_3 / 3));
...
bool computing_the_normal_on_a_translated_sphere() {
    ...
    mn::Vector n = sphere.normal_at(mn::make_point(0.0, 1.0 + half_sqrt_of_2, -half_sqrt_of_2));
...
bool computing_the_normal_on_a_transformed_sphere() {
    ...
    const double half_sqrt_of_2 = std::sqrt(2.0) / 2;
    mn::Vector n = sphere.normal_at(mn::make_point(0.0, half_sqrt_of_2, -half_sqrt_of_2));
