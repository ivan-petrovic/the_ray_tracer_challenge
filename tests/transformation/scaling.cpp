...
bool test_scaling_applied_to_a_point() {
    ...
    mn::Point p = mn::make_point(-4.0, 6.0, 8.0);
    mn::Point expected = mn::make_point(-8.0, 18.0, 32.0);
...
bool test_scaling_applied_to_a_vector() {
    mn::Matrix4x4 M = mn::scaling(2.0, 3.0, 4.0);
    mn::Vector v = mn::make_vector(-4.0, 6.0, 8.0);
    mn::Vector expected = mn::make_vector(-8.0, 18.0, 32.0);
...
bool test_multiplying_by_the_inverse_of_a_scaling_matrix() {
    mn::Matrix4x4 M = mn::scaling(2.0, 3.0, 4.0);
    mn::Vector v = mn::make_vector(-4.0, 6.0, 8.0);
    mn::Vector expected = mn::make_vector(-2.0, 2.0, 2.0);
...
bool test_reflection_is_scaling_by_a_negative_value() {
    ...
    mn::Vector p = mn::make_point(2.0, 3.0, 4.0);
    mn::Vector expected = mn::make_point(-2.0, 3.0, 4.0);
